...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white/90 dark:bg-background/90 backdrop-blur-md border-b border-emerald-100/50 dark:border-emerald-900/50 sticky top-0 z-40 w-full shadow-sm">
              ...
              <div className="flex items-center bg-emerald-50/50 rounded-xl p-1 mr-6">
                {navigationItems.map((item) => (
                  <Link
                    key={item.path}
                    to={item.path}
                    className={`flex items-center px-4 py-2.5 rounded-lg font-semibold text-sm transition-all duration-200 ${isActiveRoute(item.path)
